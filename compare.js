...
const productId1 = urlParams.get('id1'); // Get first product ID
const productId2 = urlParams.get('id2'); // Get second product ID

const product1 = products.find(p => p.id == productId1);
const product2 = products.find(p => p.id == productId2);

if (product1) {
    document.getElementById('compare-image-1').src = product1.image;
    document.getElementById('compare-brand-1').innerText = product1.brand;
    document.getElementById('compare-description-1').innerText = product1.description;
    document.getElementById('compare-price-1').innerText = product1.newPrice;
    document.getElementById('link-product-1').href = `productpage.html?id=${productId1}`; // Redirect to product page
} else {
    document.getElementById('compare-product-1').innerHTML = '<p>Product not found</p>';
}

if (product1) {
    document.getElementById('compare-image-1').src = product1.image;
    document.getElementById('compare-brand-1').innerText = product1.brand;
    document.getElementById('link-product-1').href = `productpage.html?id=${product1.id}`; // Link to product page
    document.getElementById('compare-description-1').innerText = product1.description;
    document.getElementById('compare-price-1').innerText = product1.newPrice;
} else {
    document.getElementById('compare-product-1').innerHTML = '<p>Product not found</p>';
...
if (product2) {
    document.getElementById('compare-image-2').src = product2.image;
    document.getElementById('compare-brand-2').innerText = product2.brand;
    document.getElementById('link-product-2').href = `productpage.html?id=${product2.id}`; // Link to product page
    document.getElementById('compare-description-2').innerText = product2.description;
    document.getElementById('compare-price-2').innerText = product2.newPrice;
} else {
    document.getElementById('compare-product-2').innerHTML = '<p>Product not found</p>';
}
